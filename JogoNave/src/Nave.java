...
public class Nave
{
    ...
    /**
     * Altera o nome da nave
     * @param nome novo nome da nave
     */
    public void alterarNome(String nome){
    	this.nome=nome;
    }
    
    // cria um campo de forca com um numero aleatorio entre 1 e 5
    private int criarCampoDeForca(){
    ...
    public void tomarTiro()
    {
        if (estaViva)
        {
            if (campoDeForca > 0){ // se ainda tiver campo de forca, ele perde um ponto 
            	campoDeForca--;
            }
            else{ // se nao tiver campo de forca
		    // morre
		    estaViva = false;
            }
        }
