[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/FOwvX4hp)
...
*1. Para as situações propostas, as duas estratégias funcionam para tratar alguns erros que antes tínhamos, impedindo que nossa rede social feche quando o usuário escreve alguma informação equivocada e exibindo qual foi o erro.*

*2. A vantagem de usar o retorno booleano é que ele é mais simples e fácil de implementar, porém ele não funciona para todos os casos, um exemplo é quando um método já retorna naturalmente um booleano. Já a exceção é um pouco mais complexa de ser utilizada, porém ela é mais flexível e pode ser usada em todas as situações, além de ser mais fácil para o programador identificar o erro, tratar de forma diferenciada e salvá-lo no log de erros.*
