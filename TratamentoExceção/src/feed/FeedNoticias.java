...
import java.util.*;
import MensagemNaoEncontradaException;
...
public class FeedNoticias {
    ...
    /**
     * Verifica se o autor da mensagem já foi adicionado à lista de autores.
     * Se não foi, adiciona o autor à lista.
     * 
     * @param autor Nome do autor da mensagem.
     */
    private void verificarAutor(String autor) {
    ...
    /**
     * Retorna a lista de autores, de maneira imodificável para assegurar o encapsulamento, que já postaram mensagens no Feed de Noticias.
     * 
    ...
    /**
    * Sobrecarga do método getPublicacoes, que retorna a lista de publicações
    ...
    */
    public List<Publicacao> getPublicacoes(String autor) {
        // Cria uma lista de publicações somente-leitura
        List<Publicacao> publicacoes = new ArrayList<>();
        // Adiciona todas as mensagens do feed de um autor específico na lista de publicações
